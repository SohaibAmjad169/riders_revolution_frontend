...
const ContactUs = () => {
  ...
  <div className="flex flex-col md:flex-row justify-evenly items-center gap-6 md:gap-12">
    {/* Contact Info */}
    <div className="relative w-full md:w-1/2 lg:w-1/3 bg-cover bg-center rounded-lg" 
         style={{ backgroundImage: `url('https://w0.peakpx.com/wallpaper/304/871/HD-wallpaper-kawasaki-ninja-h2r-bike-black-bike-parked-black-bike-parked-bike.jpg')`, height: '700px' , width: '500px'}}>
      {/* Cards */}
      <div className="absolute bottom-4 left-4 w-200px ">
        <div className="bg-gray-100 rounded-lg p-6 mb-2 shadow-lg">
          ...
          <p className='ml-5'>+92-4567-890</p>
          </div>
          ...
          <p className='ml-5'>ridersrevolution@gmail.com</p>
          </div>
          ...
          <p className='ml-5'>Lahore, Punjab, Pakistan</p>
          </div>
